        ...
        <div>
            <div>
                <div className="my-10">
                    ...
                    />
                    <input
                        class="w-full h-8 px-2 text-sm text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline"
                        type="text"
                ...
                <div className="my-10">
                    ...
                    <div class="text-gray-700">
                        ...
                        />
                        <span class="text-xs text-gray-600" id="passwordHelp">
