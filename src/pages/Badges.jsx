...
const Badges = () => {
    return (
        <div>
            ...
            <div className="my-10">
                <h3 className="text-2xl text-gray-800">Badge sizes</h3>
            ...
            <div className="my-10">
                <h3 className="text-2xl text-gray-800">Button with badge</h3>
            ...
            <div className="my-10">
                <h3 className="text-2xl text-gray-800">Icon with badge</h3>
            ...
            <div className="my-10">
                <h3 className="text-2xl text-gray-800">Text badge</h3>
